...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <td><fmt:formatDate value="${doctor.birthday}" pattern="yyyy-MM-dd"></fmt:formatDate></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <c:if test="${doctor.department == 1}">专科</c:if>
            <c:if test="${doctor.department == 2}">本科</c:if>
            <c:if test="${doctor.department == 3}">研究生</c:if>
            <c:if test="${doctor.department == 4}">博士</c:if>
        </td>
    </tr>
	<tr>
